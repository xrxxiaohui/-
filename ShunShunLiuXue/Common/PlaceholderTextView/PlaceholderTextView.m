...
//    }
    ...
    if (self.text.length > 0) {
        PlaceholderLabel.hidden=YES;
        [[NSNotificationCenter defaultCenter] postNotificationName:@"changeButtonNormal" object:nil];
    }
    else{
        PlaceholderLabel.hidden=NO;
        [[NSNotificationCenter defaultCenter] postNotificationName:@"changeButtonHalf" object:nil];
