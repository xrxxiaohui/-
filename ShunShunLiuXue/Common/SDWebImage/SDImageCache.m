...
static NSInteger cacheMaxCacheAge = 60*60*24*5; // 1 week
...
//    [[LoadingView sharedManager] stopAnimation];
...
//    [anAlert show];
//    [anAlert release];
  [[NSNotificationCenter defaultCenter] postNotificationName:@"cacheClearSucceed" object:nil];
